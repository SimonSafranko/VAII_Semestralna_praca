...
class Klub extends Model
{
    ...
    public function getKontaktEmail(): ?string { return $this->kontakt_email; }
    public function getLogoCesta(): ?string { return $this->logo_cesta; }
    ...
    public function setKontaktEmail(string $email): void { $this->kontakt_email = $email; }
    public function setLogoCesta(?string $cesta): void { $this->logo_cesta = $cesta; }
